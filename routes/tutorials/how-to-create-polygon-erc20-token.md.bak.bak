...
meta:
  - http-equiv: refresh
    content: 0; url=https://createmytoken.net/token-generator/tutorials/how-to-create-erc20-token-on-polygon/
  - property: og:url
    content: https://bep20.github.io/token-generator/tutorials/how-to-create-polygon-erc20-token/
  - property: og:title
...
Visit [Polygon ERC20 Token Generator](https://bep20.github.io/polygon-generator/)
...
**[Token Generator](https://createmytoken.net/)** is a software registered by [Vittorio Minacori](https://vittorio.minacori.me)
...
If you have a technical or support question, a privacy concern, complaint, or any type of question, please open an issue [here](https://github.com/bep20/token-generator/issues) or send a PM to [@Erc20Generator](https://twitter.com/Erc20Generator).
